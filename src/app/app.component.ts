...
export class AppComponent  {
  ...
  createGraph(){
    ...
    this.options = {
      chart: {
        ...
        xAxis: {
            ...
            //     return d3.format('%x')(new Date(d))
            // }
            tickFormat: function(d){
              return d3.format(',.100f')(d);
          }
        },
        yAxis: {
            tickFormat: function(d){
    ...
    // console.log(this.fileData,'yo');
    // this.fileData.groups[0].peaks.forEach(item => {
    //   item.eic.rt.forEach(element => {
    //     this.graphData.values.push({
    //       label: element
    //     })
    //   });
    //   item.eic.intensity.forEach(element => {
    //     this.graphData.values.push({
    //       value: element
    //     })
    //   });
    ...
    // this.fileData.groups[0].peaks.eic.intensity.forEach(item => {
    //   this.graphData.values.push({
    //     value: item
    //   })
    // });
    ...
    this.fileData.groups[0].peaks.forEach(item=>{
      let length=item.eic.intensity.length;
      console.log(length);
      let gt =[];                                                                                                                                   
